...
jest.mock('@/components/ui/card', () => ({
  ...
  CardFooter: ({ children, className }: { children: React.ReactNode, className?: string }) => <div className={className} data-testid="card-footer">{children}</div>,
}));

jest.mock('@/components/ui/button', () => ({
  Button: ({ children, onClick, variant, size, disabled, className, type }: { children: React.ReactNode, onClick?: () => void, variant?: string, size?: string, disabled?: boolean, className?: string, type?: string }) =>
    <button onClick={onClick} disabled={disabled} className={className} type={type} data-testid={`button-${variant || 'default'}`}>{children}</button>,
...
jest.mock('@/components/ui/input', () => ({
  Input: ({ placeholder, value, onChange, type, disabled, className }: { placeholder?: string, value?: string, onChange?: (e: any) => void, type?: string, disabled?: boolean, className?: string }) =>
    <input placeholder={placeholder} value={value} onChange={onChange} type={type} disabled={disabled} className={className} />,
}));
